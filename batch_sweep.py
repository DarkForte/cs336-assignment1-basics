...
def main():
    ...
    parser.add_argument("--total_tokens", type=int, default=40000000, help="Total tokens to process for each batch size")
    ...
    for batch_size in batch_sizes:
        ...
        losses = train_with_params(args, dataset, args.total_tokens, "batch_size", batch_size)
